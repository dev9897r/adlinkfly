    ...
    <div class="tab-content">
        ...
        <div role="tabpanel" id="links" class="tab-pane fade in active">
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    <?=
                    $this->Form->control('Options.' . $settings['enable_random_ad_type']['id'] . '.value', [
                        'label' => false,
                        'options' => [
                            1 => __('Yes'),
                            0 => __('No'),
        ...
        <div role="tabpanel" id="earnings" class="tab-pane fade in">
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    <?=
                    $this->Form->control('Options.' . $settings['counter_value']['id'] . '.value', [
                        'label' => false,
                        'class' => 'form-control',
                        'type' => 'number',
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    ...
                    $this->Form->control('Options.' . $settings['captcha_type']['id'] . '.value', [
                        'label' => false,
                        'options' => [
                            'securimage' => __('Simple Captcha(Securimage)'),
        ...
        <div role="tabpanel" id="social" class="tab-pane fade in">
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    <?=
                    $this->Form->control('Options.' . $settings['google_plus_url']['id'] . '.value', [
                        'label' => false,
                        'class' => 'form-control',
                        'type' => 'url',
        ...
        <div role="tabpanel" id="cronjob" class="tab-pane fade in">
            <legend><?= __('Cron Job Command') ?></legend>
            <code>
                * * * * * php -d 'register_argc_argv=on;' -d 'apc.enabled=0;' <?= ROOT ?>/bin/cake.php schedule >> /dev/null 2>&1
            </code>
        </div>
